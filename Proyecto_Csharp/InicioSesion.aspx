<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InicioSesion.aspx.cs" Inherits="Proyecto_Csharp.Default" %>
	...
	<div class="full-box login-container cover">
		<form id="login" method="post" autocomplete="off" class="logInForm" runat="server">
			...
			<div class="form-group label-floating">
                ...
                <asp:TextBox ID="usuario" runat="server" CssClass="form-control" ForeColor="White"></asp:TextBox>
			...
			<div class="form-group text-center">
                <asp:Button ID="Button1" runat="server" Text="Iniciar Sesion" CssClass="btn btn-info" style="color: #FFF;" OnClick="Button1_Click" />
			</div>
		</form>
	</div>
	<!--====== Scripts -->
